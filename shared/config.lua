...
Config.Window = {
    size = {
        ...
        height = 155    -- Plus haut qu'un item normal pour loger les portraits
    },
    ...
    portraits = {
        ...
        mom = {
            ...
            offsetX = 65,                   -- distance depuis le bord gauche du menu
            size    = 150,                   -- largeur ET hauteur du portrait mère (px)
            color   = { r = 255, g = 255, b = 255, a = 255 }
        },
        dad = {
            prefix  = "male_",              -- nom du sprite = prefix .. dadIndex  ex: "male_3"
            offsetX = 65,                   -- distance depuis le bord droit du menu (symétrique)
            size    = 150,                   -- largeur ET hauteur du portrait père (px)
            color   = { r = 255, g = 255, b = 255, a = 255 }
        }
    }
}
...
Config.Window.size.width       = Config.Header.size.width
